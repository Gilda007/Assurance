...
class Compagnie(Base):
    ...
    # --- BLOC DE TRAÇABILITÉ ---
    # --- TRAÇABILITÉ EN ENTIER (ID) ---
    created_at = Column(DateTime, default=datetime.now)
    create_by = Column(Integer, ForeignKey('utilisateurs.id')) # Relation vers l'ID utilisateur
    modify_at = Column(DateTime, onupdate=datetime.now)
    modify_by = Column(Integer, ForeignKey('utilisateurs.id'))
