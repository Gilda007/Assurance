# # addons/Automobiles/views/widgets/modern_card.py (version complète corrigée)
# """
...
#         # Ombre portée
#         self.shadow = create_shadow(blur=20, offset_y=4, color=QColor(0, 0, 0, 15))
...
#         # Widget de contenu (remplace le contenu existant)
...
#         self.content_layout.insertLayout(0, header_layout)
...
#         self.animation.setEndValue(QPoint(self.pos().x(), self.pos().y() - 4))
...
#         """Définit le contenu principal (remplace le contenu existant)"""
...
#         container = QWidget()
#         content_container_layout = QVBoxLayout(container)
#         content_container_layout.setSpacing(Spacing.SM)
#         content_container_layout.addWidget(self.value_label, alignment=Qt.AlignCenter)
#         content_container_layout.addWidget(title_label, alignment=Qt.AlignCenter)
...
#             content_container_layout.addLayout(trend_layout)
