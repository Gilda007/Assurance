...
datas = [('addons', 'addons'), ('server/config.py', '.'), ('version_manager.py', '.'), ('update_manager.py', '.'), ('update_dialog.py', '.'), ('update_client.py', '.'), ('update_widget.py', '.'), ('updates/update_server.py', '.'), ('core/workers', '.')]
binaries = []
