...
from addons.Automobiles.models.automobile_models import AuditFlotteLog, Vehicle, Fleet AuditVehicleLog
from addons.Automobiles.models.contract_models import Contact
