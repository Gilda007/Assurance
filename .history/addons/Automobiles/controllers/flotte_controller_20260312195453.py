...
from addons.vehicule_management.models.models import AuditFlotteLog, Vehicle, Fleet
from addons.contact_manager.models.models import Contact
from addons.vehicule_management.models.models import Vehicle, Fleet, AuditVehicleLog
from addons.vehicule_management.controller.vehicle_controller import VehicleController
...
class FleetController:
    ...
    #     """Crée une nouvelle flotte dans la base de données."""
    #     now = datetime.now()
    #     try:
    #         local_ip, public_ip = self.get_network_info()
        
    #         # Injection dans les données du véhicule pour la table vehicles
    ...
    #         new_fleet.created_by = user_id
    #         self.session.add(new_fleet)
    #         self.session.flush() # Récupère l'ID du véhicule sans commiter
    ...
    #             old_values=None,
    #             new_values=str(data.get('immatriculation', 'marque')), # On peut stocker plus de détails si besoin
