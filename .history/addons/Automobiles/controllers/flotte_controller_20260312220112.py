...
from addons.Automobiles.models.automobile_models import AuditVehicleLog, Vehicle, Fleet 
from addons.Automobiles.models.contract_models import Contract
from addons.Automobiles.models.flottes_models import Vehicle, Fleet, AuditVehicleLog
...
class FleetController:
    ...
    def get_all_contacts_for_combo(self):
        ...
        try:
            ...
            compagnies = self.session.query(Contract.id, Contract.nom)\
                .filter(Contract.nature == "Physique")\
                .all()
    ...
    def get_all_compagnies_for_combo(self):
        ...
        try:
            # On récupère spécifiquement les colonnes ID et NOM
            compagnies = self.session.query(Contract.id, Contract.contact)\
                .filter(Contract.nature == "Morale")\
                .all()
