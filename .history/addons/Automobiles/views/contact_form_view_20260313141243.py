...
class ContactForm(QDialog):
    ...
    def setup_ui(self):
        ...
        self.container.setStyleSheet("""
            #MainContainer { background-color: #ffffff; border-radius: 20px; border: 1px solid #1e293b; }
    ...
    def get_data(self):
        ...
        return {
            ...
            "num_permis": self.num_permis.text(),
