...
from addons.Automobiles.views.compagnies_form_view import CompanyTariffView
from addons.Automobiles.views.tarif_form_view import CompanyTariffView
...
class CompanyTariffView(QWidget):
    ...
    def on_add_tarif_click(self):
        # 'self' devient le parent du dialogue (un QWidget)
        dialog = FormulaireCreationTarif(self, self.controller, self.user) 
        
        # Très important pour que exec_() renvoie True lors du clic sur le bouton
