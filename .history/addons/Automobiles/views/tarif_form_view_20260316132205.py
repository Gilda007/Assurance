...
class CompanyTarifForm(QDialog):
    ...
    def setup_ui(self):
        ...
        self.container.setStyleSheet("background-color: white; border-radius: 25px; border: 2px solid #1e293b;")
        ...
        header.setStyleSheet("background: white; border-top-left-radius: 25px; border-top-right-radius: 25px; border=None;")
        h_layout = QHBoxLayout(header)
        h_layout.setContentsMargins(40, 0, 40, 0)
        
        title_label = QLabel("Configuration Avancée du Tarif")
        title_label.setStyleSheet("font-size: 22px; font-weight: 900; color: #0f172a; border=None;")
        ...
        btn_close.setStyleSheet("""
            QPushButton { background: #f8fafc; border-radius: 17px; color: #64748b; font-weight: bold; border=None;}
        ...
        footer.setStyleSheet("""border=None;""")
