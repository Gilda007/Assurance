...
class ContactForm(QDialog):
    ...
    def setup_ui(self):
        ...
        # Titre
        header_title = QLabel("📋 CRÉATION DE DOSSIER CLIENT")
        ...
        # Bouton Fermer (Style Cercle Rouge)
        ...
        header_layout.addStretch() # Pousse le bouton vers la droite
        header_layout.addWidget(self.btn_close)
        
        # On ajoute le layout horizontal au container principal
        ...
        self.container.setLayout(footer)

        main_layout.addWidget(self.container)

        # Connexions
        self.btn_power.clicked.connect(self.toggle_camera)
        self.btn_snap.clicked.connect(self.update_frame)
    ...
    def toggle_camera(self):
        ...
        if self.cap is None:
            ...
            self.stop_camera()
            self.toggle_camera.setText("✅ Photo Prise")
