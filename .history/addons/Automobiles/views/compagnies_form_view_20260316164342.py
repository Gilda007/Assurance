...
class FormulaireCreationCompagnie(QDialog):
    ...
    def set_data(self, data):
        ...
        # Utilisez les noms de variables que vous avez définis dans setup_ui
        self.edit_nom.setText(data.get('nom', ''))
        self.edit_code.setText(data.get('code', ''))
        self.edit_email.setText(data.get('email', ''))
        self.edit_phone.setText(data.get('telephone', ''))
        self.edit_adresse.setText(data.get('adresse', ''))
        self.input_debut.setText(data.get('num_debut', ''))
        self.input_fin.setText(data.get('num_fin', ''))
        
        # Optionnel : Désactiver l'édition du code si c'est une clé unique
        self.edit_code.setReadOnly(True)
        self.edit_code.setStyleSheet("background-color: #f0f0f0; color: #7f8c8d;")