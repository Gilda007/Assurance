...
class VehicleMainView(QWidget):
    ...
    def setup_ui(self):
        ...
        self.kpi_layout.addWidget(self._create_kpi_card("Sinistres", "08", "#ef4444", "#ec7e7e"))
        self.kpi_layout.addWidget(self._create_kpi_card("Clients", "89", "#f59e0b", "#ecc788"))
    ...
    def _create_kpi_card(self, title, value, color, bgcolor):
        ...
        card.setStyleSheet(f"""
            QFrame {{
                background-color: {bgcolor}; border-radius: 15px;
        ...
        v = QLabel(value)
        v.setStyleSheet(f"color: whit; font-size: 28px; font-weight: 900;")
        layout.addWidget(t)
        layout.addWidget(v)
        return card
