...
from addons.contact_manager.security.access_control import Permissions, SecurityManager
from addons.contact_manager.security.access_control import Permissions
from addons.contact_manager.models.models import ContactAuditLog
from addons.contact_manager.views.contact_card import ContactCard
from addons.contact_manager.views.dialog_form import ContactForm # Assure-toi de l'import
from core.alerts import AlertManager
from PySide6.QtCharts import QChartView, QPieSeries, QChart, QLegend
from PySide6.QtGui import QPainter, QColor, QFont
from addons.contact_manager.reports.pdf_generator import generate_contact_pdf
...
class ContactListView(QWidget):
    ...
    def display_contacts(self, contacts):
        ...
        stats_data = self.controller.get_contact_stats()
    ...
    def on_add_click(self):
        ...
        if dialog.exec_():
            ...
            # Appel au contrôleur
            result = self.controller.create_contact(new_data)
            ...
            if success and hasattr(new_contact, 'nom'):
                ...
                # Log de l'action
                self.controller.log_contact_action("CRÉATION", new_contact.id, details)
    ...
    def on_edit_click(self, contact_obj):
        ...
        fresh_contact = self.controller.get_contact_by_id(contact_obj.id)
        if fresh_contact:
        ...
        # ou avec le nom exact défini dans ContactForm.__init__
            ...
            if dialog.exec():
                ...
                new_stats = self.controller.get_contact_stats() 
    ...
    def open_contact_folder(self, contact):
        folder_path = contact.dossier_client       
