...
class FormulaireCreationCompagnie(QDialog):
    ...
    def set_data(self, data):
        """Remplit les champs en utilisant les attributs créés dynamiquement."""
        # On mappe les clés du dictionnaire 'data' aux attributs 'self.input_...'
        mapping = {
            'nom': self.input_nom,
        ...
        for key, field in mapping.items():
            field.setText(str(data.get(key, '')) if data.get(key) else "")

        # Sécurité : On verrouille le code en mode édition
        self.input_code.setReadOnly(True)
        self.input_code.setStyleSheet(self.input_code.styleSheet() + 
