...
class ContactCard(QFrame):
    def __init__(self, contact, on_edit, on_delete, on_open_folder, user_role):
        ...
        # Badge
        type_val = str(contact.civilite or "Particulier")
        badge_bg = "#10b981" if "Société" in type_val.upper() else "#f59e0b"
        ...
        name.setStyleSheet(f"font-weight: 800; font-size: 14px; color: {self.text_color}; background: transparent; border: none;")
