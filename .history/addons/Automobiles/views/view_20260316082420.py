...
class VehicleMainView(QWidget):
    ...
    def setup_ui(self):
        ...
        self.self.btn_clients.clicked.connect(lambda: self._switch_page(2, self.btn_clients))  = self._create_nav_btn("📦 Compagnies et Tarifs")
    ...
    def _switch_page(self, index, btn):
        ...
        print(index)
        # Reset styles
        for b in [self.btn_dash, self.btn_vehicles, self.btn_clients]:
