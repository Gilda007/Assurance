    ...
    def display_page(self, row):
        ...
        if key not in self.pages_cache:
            ...
            if key == "users":
                ...
                print(f"DEBUG: Création de UserListPage avec controller={ctrl} et user={self.user}")
            ...
            # Dans views.py, à l'intérieur de display_page
                ...
                try:
                    ...
                    print(f"DEBUG: Création de ParametreModuleWidget avec controller={module_ctrl} et user={self.user}")
                ...
                if self.user is not None:
                    # On passe bien les DEUX arguments maintenant
                    print(f"DEBUG: Création de AccountSettingsView avec controller={self.controller} et user={self.user}")
                    page = AccountSettingsView(self.controller, self.user) 
                else:
                    page = QLabel("Erreur : Session utilisateur introuvable.")
