...
class UserListPage(QWidget):
    def __init__(self, controller=None, current_user=None, **kwargs):
        ...
        role = getattr(self.user, 'role', 'guest') 
    ...
    def display_users(self, users):
        ...
        if user_page and hasattr(user_page, 'table'):
            user_page.table.setRowCount(0)
            # ... logique pour remplir le tableau
        else:
            print("Erreur : La page utilisateur n'est pas chargée ou n'a pas de tableau.")
